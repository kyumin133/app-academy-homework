...
View.prototype.exercise1 = function () {
  ...
  // $('li.square').css("background-color", "white")
...
View.prototype.exercise3 = function () {
  ...
  //your code here!
  $('div[id="easel"]').after("<h1>i love jquery</h1>");
};
...
View.prototype.exercise6 = function () {
  ...
  $( () => {
    ...
    $('li.square').each(function (square) {
...
View.prototype.exercise7 = function(){
  ...
  //your code here!
  $('li.square').on("mouseover", function(e) {
    $currentTarget = $(e.currentTarget);
